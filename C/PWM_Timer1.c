...
// Timer Period: 20 ms
// Output Pulse(s):
// OC1A Period: 20 ms Width: 1 ms// OC1B Period: 20 ms Width: 2 ms
// Timer1 Overflow Interrupt: Off
// Input Capture Interrupt: Off
// Compare A Match Interrupt: Off
// Compare B Match Interrupt: Off
// Compare C Match Interrupt: Off
TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (1<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (1<<WGM11) | (0<<WGM10);
...
while (1){
      for (i=0x0271; i<=0x2BF2; i = i+25){
        OCR1A=i;
        delay_ms(100);
      };
      for (i=0x2BF2; i>=0x0271; i = i-25){
        OCR1A=i;
        delay_ms(100);
      };
   }
